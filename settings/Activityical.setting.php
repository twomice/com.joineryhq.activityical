...
return array(
  ...
  'activityical_include_url' => array(
    ...
    'is_domain' => 1,
    'is_contact' => 0,
    'description' => E::ts('Include a link (URL) to the CiviCRM activity view in each feed event? Disable this if feed subscribers do not have access to view activities in CiviCRM, to avoid presenting them with inaccessible links.'),
    'title' => E::ts('Include Link to Activity'),
    'help_text' => '',
    'html_type' => '',
    'quick_form_type' => 'YesNo',
    'default' => 1,
